...
%    pointsInCluster (row vector with the nbDatapoints belonging to  the centroid),
%         assignment (row Vector with clusterAssignment of the dataRows) ] = kmeans(data, k)

% matlab [IDX,C,sumd,D] = kmeans(X,k)
% octave 
