...
# orig        if ((~isempty(lbl_pos)) & (~isempty(bra_pos)) & (x(node) == 0))  % make sure we have not seen it 
#danbri'd
...
#into http://www.mathworks.de/matlabcentral/newsreader/view_thread/263130
...
# danbri: got error here:
##warning: possible Matlab-style short-circuit operator at line 100, column 27
